-- Force Clean Social Feed Migration
-- This migration will force drop all existing functions with specific signatures

-- 1. Drop ALL existing social feed functions with specific signatures
DROP FUNCTION IF EXISTS public.get_social_feed(uuid, integer, integer, text[], boolean) CASCADE;
DROP FUNCTION IF EXISTS public.get_social_feed(uuid, integer, integer) CASCADE;
DROP FUNCTION IF EXISTS public.get_social_feed(uuid, integer) CASCADE;
DROP FUNCTION IF EXISTS public.get_social_feed(uuid) CASCADE;

DROP FUNCTION IF EXISTS public.get_activity_feed(uuid, integer, integer, text[]) CASCADE;
DROP FUNCTION IF EXISTS public.get_activity_feed(uuid, integer, integer) CASCADE;
DROP FUNCTION IF EXISTS public.get_activity_feed(uuid, integer) CASCADE;
DROP FUNCTION IF EXISTS public.get_activity_feed(uuid) CASCADE;

DROP FUNCTION IF EXISTS public.update_post_like_count(uuid, integer) CASCADE;
DROP FUNCTION IF EXISTS public.update_post_comment_count(uuid, integer) CASCADE;
DROP FUNCTION IF EXISTS public.update_post_repost_count(uuid, integer) CASCADE;
DROP FUNCTION IF EXISTS public.get_post_comments(uuid) CASCADE;

DROP FUNCTION IF EXISTS public.debug_social_feed_tables() CASCADE;
DROP FUNCTION IF EXISTS public.create_test_social_post(uuid, text, text) CASCADE;
DROP FUNCTION IF EXISTS public.create_test_social_post(uuid, text) CASCADE;
DROP FUNCTION IF EXISTS public.create_test_social_post(uuid) CASCADE;
DROP FUNCTION IF EXISTS public.get_social_feed_debug_info(uuid) CASCADE;

-- 2. Also drop any v2 functions that might exist
DROP FUNCTION IF EXISTS public.get_social_feed_v2(uuid, integer, integer, text[], boolean) CASCADE;
DROP FUNCTION IF EXISTS public.get_activity_feed_v2(uuid, integer, integer, text[]) CASCADE;
DROP FUNCTION IF EXISTS public.update_post_like_count_v2(uuid, integer) CASCADE;
DROP FUNCTION IF EXISTS public.update_post_comment_count_v2(uuid, integer) CASCADE;
DROP FUNCTION IF EXISTS public.update_post_repost_count_v2(uuid, integer) CASCADE;
DROP FUNCTION IF EXISTS public.get_post_comments_v2(uuid) CASCADE;
DROP FUNCTION IF EXISTS public.debug_social_feed_tables_v2() CASCADE;
DROP FUNCTION IF EXISTS public.create_test_social_post_v2(uuid, text, text) CASCADE;
DROP FUNCTION IF EXISTS public.get_social_feed_debug_info_v2(uuid) CASCADE;

-- 3. Ensure all tables have the correct structure and RLS policies
...
-- 4. Drop and recreate all RLS policies for social_posts
...
-- 7. Create RLS policies for post_reposts
...
-- 8. Create the main get_social_feed function with a completely new name
...
BEGIN
  ...
  RAISE LOG 'get_social_feed_final called with user_id: %, limit: %, offset: %, post_types: %, connections_only: %', 
...
CREATE OR REPLACE FUNCTION public.get_activity_feed_final(
  p_user_id uuid,
  p_limit integer DEFAULT 20,
  p_offset integer DEFAULT 0,
...
-- 10. Create helper functions for post interactions
...
CREATE OR REPLACE FUNCTION public.create_test_social_post_final(
  p_user_id uuid,
...
GRANT EXECUTE ON FUNCTION public.get_activity_feed_final TO authenticated;
...
GRANT EXECUTE ON FUNCTION public.create_test_social_post_final TO authenticated;
